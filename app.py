...
if generate_btn:
    if not api_key_input:
        ...
        try:
            ...
            3. 모바일 화면 가독성을 극대화하기 위해 긴 문단을 쓰지 말고, 한두 줄마다 짧게 엔터(줄바꿈)를 쳐서 호흡을 시원시원하게 나눌 것. (예: 1~2줄 쓰고 줄바꿈)
            ...
            2. 구조 및 모바일 가독성 점수 (30점 만점): 마크다운 기호 없이 엔터 줄바꿈이 모바일 친화적으로 잘 되었는지 평가.
            ...
            progress_text.empty()
            st.success("🎉 실시간 팩트체크 웹 리서치와 SEO 분석이 완료된 고품질 블로그 패키지가 생성되었습니다!")
